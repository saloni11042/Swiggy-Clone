...
$('.product-container').on({
    "mouseenter": function() {
        ...
        $(this).children('.card-hidden-part').css("visibility", "visible"),
        $(this).css("box-shadow", "0 0 20px 0 rgba(197, 189, 189, 0.8)")},
    "mouseleave": function() { 
        $(this).css("borderStyle", "none"),
        $(this).children('.card-hidden-part').css("visibility", "hidden"),
